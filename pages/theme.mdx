...
<img style={{marginTop: '10px'}} src="/img/toggle-replaceable-components.png" />
...
make the developer instructions appear in a modal.

<img style={{marginTop: '10px'}} src="/img/example-description-to-replace-component.png" />
