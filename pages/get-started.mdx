...
#### Optional extras
Once you have the basics setup, then you can start enhancing the implementation by [customizing the dashboard](/custom-theme) to fit 
into your application, and [making performance tweaks](/performance) to improve the overall experience!
