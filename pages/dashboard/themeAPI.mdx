...
The apart from the `detail` and `rowLimit` props, the `theme` properties aren't mandatory.
...
It's in our roadmap to allow for futher customisation of the Dashboard component. These include:
