...
export namespace Result {
  ...
  export type Field = {
    ...
    // For example, if the field holds a `count` aggregation off
...
The Vizzly frontend performs some basic validations upon the results generated based on the query that
was sent. If things aren't working as expected, it is always worth checking the console output in the browser
to see if there's a friendly validation error message waiting for you. If not, please get in-touch and
we can work with you on debugging it!
