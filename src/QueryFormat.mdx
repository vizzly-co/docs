...
<Callout emoji="❗">
  Please note, we will soon be migrating to a new query format.
  Please contact us before building new features that rely on this soon-to-be deprecated format.

  We shall continue to support this deprecated format, however all
  new Vizzly features will rely on the new format.
</Callout>
