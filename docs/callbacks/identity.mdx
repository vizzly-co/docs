...
<RemoteCodeBlock
  lines={[29, 60]}
  language='ts'
  fileUrl='https://raw.githubusercontent.com/vizzly-co/examples/main/examples/next-js/pages/api/identity.js'
/>
...
<RemoteCodeBlock language='ts' fileUrl='https://raw.githubusercontent.com/vizzly-co/examples/main/examples/next-js/pages/api/identity.js' />
</TabItem>
