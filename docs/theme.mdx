...
Vizzly ships with a `VizzlyTheme` react component which provides a sensible default theme to get you started quickly. However, when the time comes to customize the
