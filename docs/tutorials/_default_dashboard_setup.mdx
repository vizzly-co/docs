...
2. Click "create new"
3. Select the "US Sales tutorial" data resource when you are shown a preview of your available data resources.
<img src="/img/us-sales-tutorial-data-set-preview.png" />
...
on the dashboard, then next time hit the "plus" icon instead.
